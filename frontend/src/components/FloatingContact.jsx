  ...
  return (
    <div className="fixed bottom-5 right-5 z-40 flex flex-col items-end gap-3">
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="group relative flex h-16 w-16 items-center justify-center rounded-full bg-ink text-amber shadow-lg shadow-ink/20"
      >
        <span className="pointer-events-none absolute right-full mr-3 origin-right scale-x-0 whitespace-nowrap rounded-full bg-ink px-3 py-1.5 text-xs font-medium text-paper opacity-0 shadow-md transition-all duration-200 group-hover:scale-x-100 group-hover:opacity-100">
      ...
      <motion.a
        ...
        whileHover={{ scale: 1.08 }}
        whileTap={{ scale: 0.95 }}
        className="group relative flex h-16 w-16 items-center justify-center rounded-full bg-mint text-white shadow-lg shadow-mint/30"
      >
        <span className="pointer-events-none absolute right-full mr-3 origin-right scale-x-0 whitespace-nowrap rounded-full bg-ink px-3 py-1.5 text-xs font-medium text-paper opacity-0 shadow-md transition-all duration-200 group-hover:scale-x-100 group-hover:opacity-100">
